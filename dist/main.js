...
const gameLoop = () => {
  ...
  const play = () => {
    ...
    (0,_domInteraction_js__WEBPACK_IMPORTED_MODULE_1__.updateGameGrid)(player.gameboard.board, 'player');
    let turn = 1;
